...
def main():
    ...
    years = ['年を選択してください'] + list(range(current_year, current_year + 2))  # プレースホルダーを追加
    ...
    if selected_year != '年を選択してください' and selected_month != '月を選択してください':
        ...
        if uploaded_file is not None:
            employees_data, full_time_employees_data = process_data(uploaded_file)
            if employees_data and full_time_employees_data:
                result = run_optimization(employees_data, full_time_employees_data, selected_year,selected_month)
